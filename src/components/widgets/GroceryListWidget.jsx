...
function GroceryList() {
  ...
  return (
    <div className="bg-white p-6 flex flex-col justify-between">
      ...
      <button onClick={handleSubmit} className="w-full justify-center rounded-md bg-green-600 p-2 my-3 text-sm font-semibold leading-6 text-black shadow-lg hover:bg-amber-500">
        Add Item To Shopping List
      </button>
