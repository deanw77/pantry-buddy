          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg p-6 shadow-md transition duration-300 ease-in-out transform hover:shadow-lg">
              <div className="text-gray-700 text-lg mb-4">
                PantryBuddy has been a game-changer for our family. With two kids and a busy schedule, keeping track of pantry items was always a challenge. Thanks to intuitive PantryBuddy  interface and expiry date reminders, we have significantly cut down on food waste. Plus, the recipe suggestions based on what is expiring soon have been a lifesaver!
              </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-md transition duration-300 ease-in-out transform hover:shadow-lg">
              <div className="text-gray-700 text-lg mb-4">
                PantryBuddy has revolutionized how I approach meal planning and grocery shopping. Knowing what I have in my pantry and what is about to expire has not only helped me save money by reducing food waste, but it is also inspired me to get creative in the kitchen with the recipe suggestions. It is like having a personal chef and environmentalist in my pocket!
              </div>
              <div className="flex items-center mt-4">
                <img
                  className="h-11 w-11 rounded-full mr-4"
